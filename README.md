...
**Hands-on practice** through platforms like Hack The Box, Root-Me, and Natas ties everything together — applying concepts from all the above areas to real challenges.
...
| Topic | Link |
|---|---|
| The Linux Command Line (TLCL) | [TLCL.md](https://github.com/alipzsh/knowledge-base/blob/master/TLCL.md) |
| Linux storage | [Linux storage.md](https://github.com/alipzsh/knowledge-base/blob/master/Linux%20storage.md) |
| File permissions & SUID | [SUID.md](https://github.com/alipzsh/knowledge-base/blob/master/SUID.md) |
...
| LXC containers | [lxc.md](https://github.com/alipzsh/knowledge-base/blob/master/lxc.md) |
...
| Python requests library | [python requests.md](https://github.com/alipzsh/knowledge-base/blob/master/python%20requests.md) |
...
| UNION-based SQLi | [SQLi UNION.md](https://github.com/alipzsh/knowledge-base/blob/master/SQLi%20UNION.md) |
...
| OGNL injection | [OGNL.md](https://github.com/alipzsh/knowledge-base/blob/master/OGNL.md) |
...
| WAF bypass | [bypass WAF.md](https://github.com/alipzsh/knowledge-base/blob/master/bypass%20WAF.md) |
| Bypass XSS filters | [bypass xss filters.md](https://github.com/alipzsh/knowledge-base/blob/master/bypass%20xss%20filters.md) |
| URL validation | [URL_validation.md](https://github.com/alipzsh/knowledge-base/blob/master/URL_validation.md) |
...
*[alipzsh/knowledge-base](https://github.com/alipzsh/knowledge-base) · 186 commits*
